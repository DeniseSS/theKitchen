...
public class ClienteView {
    ...
    public void mostrarListaClientes(List<Cliente> clientes) {
      ...
      for (Cliente cliente : clientes) {
        System.out.println("Nome: " + cliente.getNomeCliente() + ", Telefone: " + cliente.getTelefone() + ", CPF: " + cliente.getCpf() + ", Sobrenome: " + cliente.getSobrenome() + ", Endereço: " + cliente.getEndereco());
      }
    }
